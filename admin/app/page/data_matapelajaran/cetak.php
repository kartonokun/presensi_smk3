...
if (isset($_GET['input'])) {
    ...
    <?php
    action_cetak("data_matapelajaran");
} else {
    ...
    proses_action_cetak("data_matapelajaran");
    ?>
    <link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new.css">
    <link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new2.css">
    ...
    <?php */ ?>
    <?php
    $logo1 = "../../../../admin/data/image/logo/logo.png";
    $logo2 = "../../../../admin/data/image/logo/logo2.png";
    echo kop($logo2,$logo1);
     ?>
    <!-- HEADER -->
    ...
    <table width="100%"  class="tblcms2">
        <tr>
            ...
            <th class="th_border cell">Matapelajaran </th>
        ...
        <tbody>
            ...
            if (isset($_GET['isi']) && !empty($_GET['isi'])) {
                ...
                $querytabel = "SELECT * FROM data_matapelajaran where $Berdasarkan like '%$isi%'";
                ...
                $querytabel = "SELECT * FROM data_matapelajaran where ($Berdasarkan BETWEEN '$tanggal1' AND '$tanggal2')";
            } else {
                //SEMUA
                $querytabel = "SELECT * FROM data_matapelajaran";
            }
