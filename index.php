...
<td><h1><font color='black'>&nbsp;&nbsp;APLIKASI ABSENSI WAJAH SISWA SMKN 3 PANDEGLANG &nbsp;&nbsp;</font></h1></center></td>
<td align="center"><img src="admin/data/image/logo/logo.png" width="100px"></td>
...
<div id="parent1" style="padding-left: 20px;">
    ...
    <div class="margin" style="position: relative; float:left; border: 3px solid #fbd84a;
      ...
      ">
        ...
        <video id="vidDisplay" style="height: 500px; width: 580px; display: inline-block; vertical-align: baseline;"
