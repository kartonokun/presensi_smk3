...
<?php
    function kop($logo1, $logo2) {
        ...
        <img src="<?php echo $logo1; ?>" alt="" style="margin-right: 10px; width: 10%;">            
        <span style="text-align: center;"><font style="font-size: 16px; font-weight: 700;">
        <p>PEMERINTAH PROVINSI BANTEN <br> DINAS PENDIDIKAN DAN KEBUDAYAAN<br>UNIT PELAYANAN TEKNIS<br></font><font style="font-size: 25px; font-weight: 700;">
        SMK NEGERI 3 PANDEGLANG</font><br>Jl.  Perintis Kemerdekaan Caringin Labuan  Kabupaten Pandeglang Provinsi Banten  42264<br>
        &nbsp;<i class="fa fa-phone"></i>&nbsp; (0253) 5807068&nbsp;<i class="fa fa-envelope"></i>&nbsp;smkn03pdg@yahoo.com  Website : smkn3pandeglang.sch.id
    </p></span>
        
        <img src="<?php echo $logo2; ?>" alt="" style="margin-left: 10px; width: 10%;">        
        </div>
        <br>
